...
<body>
  <div class="wrapper">
    <div class="header">
      <div class="header-logo">RICHFIELD</div>
    ...
    <div class="body">
      ...
      <p class="para">
        Thank you for submitting your application to <strong>Richfield Graduate Institute of Technology</strong>.
  ...
  return {
    ...
    subject: `Application Received – Reference ${data.studentId} | Richfield`,
    html,
  };
};
...
export const sendApprovalEmail = async (data: ApprovalEmailData): Promise<{ success: boolean; message: string }> => {
  ...
  const sent = JSON.parse(localStorage.getItem('sentEmails') || '[]');
  sent.unshift({ to: data.email, toName: `${data.firstName} ${data.lastName}`, subject: `Application Approved — Welcome to Richfield | ${data.studentId}`, html, sentAt: new Date().toISOString(), type: 'approval' });
  ...
  try {
    ...
    await emailjs.send(
      ...
      EMAILJS_CONFIG.TEMPLATE_ID,
      {
        ...
        subject:   `🎉 Application Approved — Welcome to Richfield | ${data.studentId}`,
        html_body: html,
      },
    );
...
<head>
  ...
  <title>Application Approved — Richfield</title>
</head>
  ...
  <div style="max-width:620px;margin:32px auto;background:white;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,26,77,0.12);">
    ...
    <div style="padding:36px 40px;">
      ...
      <p style="font-size:15px;color:#374151;line-height:1.75;margin:0 0 18px;">
        ...
        <strong>Richfield Graduate Institute of Technology</strong> has been
        <strong style="color:#059669;">reviewed and successfully approved</strong> by our admissions team.
        Welcome to the Richfield family! 🎓
      </p>
      ...
      <div style="background:#EEF2FF;border:1px solid #C7D2FE;border-radius:12px;padding:20px 24px;margin:24px 0;">
        ...
        <p style="font-size:14px;color:#374151;margin:0 0 14px;line-height:1.6;">You can now log in to the <strong>Richfield Student Portal</strong> to access your dashboard, register for modules, and track your progress.</p>
      ...
      <div style="border:2px solid #FEF3C7;border-radius:12px;overflow:hidden;margin:24px 0;">
        ...
        <div style="padding:16px 20px;">
          <p style="font-size:14px;color:#374151;line-height:1.7;margin:0 0 14px;">
            ...
            Please email certified copies to <strong style="color:#001A4D;">admissions@richfield.ac.za</strong> with your Student ID
            <strong style="color:#001A4D;">${data.studentId}</strong> in the subject line, or deliver them in person at any Richfield campus.
          </p>
      ...
      <table style="width:100%;border-collapse:collapse;">
        ${[
          ['1', '#003DA5', 'Submit Documents', `Email certified copies of the documents listed above to admissions@richfield.ac.za within 14 days.`],
      ...
      <div style="background:#F4F6FB;border-radius:10px;padding:18px 20px;margin-top:8px;font-size:14px;color:#374151;line-height:1.7;">
        ...
        📧 <a href="mailto:admissions@richfield.ac.za" style="color:#003DA5;font-weight:600;">admissions@richfield.ac.za</a> &nbsp;·&nbsp;
        📞 <strong>0860 742 434</strong> (0860 RICHFIELD)<br/>
        🌐 <a href="https://www.richfield.ac.za" style="color:#003DA5;">www.richfield.ac.za</a>
      </div>

      <p style="font-size:15px;color:#374151;margin:24px 0 0;line-height:1.7;">
        Once again, <strong>congratulations</strong> on this exciting new chapter. We can't wait to see you thrive at Richfield! 🌟
      </p>
    ...
    <div style="background:#001A4D;padding:26px 40px;color:rgba(255,255,255,0.5);font-size:12px;text-align:center;">
      <div style="color:white;font-weight:700;font-size:15px;letter-spacing:2px;margin-bottom:5px;">RICHFIELD</div>
      <div>Graduate Institute of Technology</div>
