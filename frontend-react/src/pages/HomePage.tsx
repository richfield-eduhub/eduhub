...
import { RICHFIELD_LOGO } from '../utils/logo';

const PROGRAMMES = [
  {
    title: 'BSc Information Technology',
    desc: 'Learn programming, networking, cybersecurity and data science.',
    url: 'https://www.richfield.ac.za/programmes/degrees/faculty-of-information-technology/bachelor-of-science-in-information-technology-bsc-it',
  ...
  },
  {
    ...
    url: 'https://www.richfield.ac.za/programmes/degrees/business-science/bachelor-of-commerce-bcom',
  ...
  },
  {
    ...
    url: 'https://www.richfield.ac.za/programmes/degrees/business-science/bachelor-of-business-administration-bba',
    ...
    <div style={{ fontFamily: 'Arial, Helvetica, sans-serif', background: '#f4f4f4' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, padding: '0 20px' }}>
          ...
          <p style={{ fontSize: 20, marginBottom: 24, opacity: 0.95 }}>
            Begin your study journey with Richfield.
          </p>
      ...
      <div style={{ background: '#173f77', color: 'white', padding: '60px 40px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 32 }}>
          ...
          <div style={{ width: 260 }}>
            <div style={{
              ...
              <img src={RICHFIELD_LOGO} style={{ width: 140 }} alt="Richfield" />
            </div>
            ...
            <div style={{ fontSize: 22, display: 'flex', gap: 14, marginTop: 8 }}>
              <a href="https://facebook.com/richfieldgit" target="_blank" rel="noreferrer" style={{ color: 'white' }}>💻</a>
              <a href="https://instagram.com/richfieldgit" target="_blank" rel="noreferrer" style={{ color: 'white' }}>📷</a>
              <a href="https://twitter.com/richfieldgit" target="_blank" rel="noreferrer" style={{ color: 'white' }}>✖</a>
          ...
          <FooterCol title="WHY RICHFIELD?" links={['Graduate Success', 'Accreditation & Recognition', 'Prospectus']} />
        ...
        <div style={{ textAlign: 'center', marginTop: 40, paddingTop: 24, borderTop: '1px solid rgba(255,255,255,0.2)', fontSize: 12, opacity: 0.55 }}>
          © {new Date().getFullYear()} Richfield Graduate Institute of Technology · All rights reserved
        </div>
      </div>
    </div>
  );
