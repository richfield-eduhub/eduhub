    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ fontFamily: 'var(--font-display)', fontSize: 14, letterSpacing: 4, opacity: 0.6, marginBottom: 32 }}>RICHFIELD GRADUATE INSTITUTE</div>
          ...
          <div style={{ marginTop: 48, borderTop: '1px solid rgba(255,255,255,0.15)', paddingTop: 32 }}>
            ...
            {[
              { role: 'Admin', email: 'admin@richfield.ac.za', pwd: 'admin123' },
              { role: 'Lecturer', email: 'smokoena@richfield.ac.za', pwd: 'lec123' },
            ].map(a => (
